...
class Email {
    ...
    public function enviarConfirmacion() {
         ...
         $mail->setFrom('acaisytem@gmail.com');
         ...
         $contenido = '<html>';
         $contenido .= "<p><strong>Hola " . $this->nombre .  "</strong> Has Registrado Correctamente tu cuenta en A.C.A.I; pero es necesario confirmarla</p>";
